...
if ($show==0) {?>
          ...
          <tr>
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[424]?></abbr>,&nbsp;<abbr title="<?php echo $text[433] ?>"><?php echo $text[442]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            ...
            <td><abbr title="<?php echo $text[427] ?>"><?php echo $text[426]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            ...
            <td><abbr title="<?php echo $text[429] ?>"><?php echo $text[428]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
          ...
          <tr>
            ...
            <td>&nbsp;<abbr title="<?php echo $text[443] ?>"><?php echo $text[503]?></abbr>: <abbr title="<?php echo $text[425] ?>"><?php echo $text[424]?></abbr>,&nbsp;<abbr title="<?php echo $text[433] ?>"><?php echo $text[442]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td>&nbsp;<abbr title="<?php echo $text[445] ?>"><?php echo $text[541]?></abbr>: <abbr title="<?php echo $text[425] ?>"><?php echo $text[424]?></abbr>,&nbsp;<abbr title="<?php echo $text[433] ?>"><?php echo $text[442]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
          ...
          <tr>
            ...
            <td><abbr title="<?php echo $text[438] ?>"><?php echo $text[437]?></abbr></td>
          </tr>
          <?php
}elseif ($show==3) {?>
          <tr>
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[451]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[452]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[453]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[454]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[455]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[456]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[457]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[458]?></abbr></td>
          </tr><?php
}elseif ($show==4) {?>
          <tr>
            <td width="20">&nbsp;</td>
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[460]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td><abbr title="<?php echo $text[425] ?>"><?php echo $text[461]?></abbr></td>
          </tr><?php
}elseif ($show==5) {?>
          <tr>
            <td width="20">&nbsp;</td>
            ...
            <td><?php echo $text[503]?>: <abbr title="<?php echo $text[425] ?>"><?php echo $text[424]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right">
            ...
            <td><?php echo $text[463]?>: <abbr title="<?php echo $text[425] ?>"><?php echo $text[424]?></abbr></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><abbr title="<?php echo $text[433] ?>"><?php echo $text[124]?> 1</abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right">
            ...
            <td><abbr title="<?php echo $text[433] ?>"><?php echo $text[124]?> 2</abbr></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><abbr title="<?php echo $text[433] ?>"><?php echo $text[466]?></abbr></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><abbr title="<?php echo $text[435] ?>"><?php echo $text[430]?></abbr></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><?php echo $text[448]?>: <abbr title="<?php echo $text[425] ?>"><?php echo $text[424]?></abbr>,&nbsp;<abbr title="<?php echo $text[433] ?>"><?php echo $text[442]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right">
            ...
            <td><?php echo $text[448]?>: <abbr title="<?php echo $text[427] ?>"><?php echo $text[426]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right">
            ...
            <td><?php echo $text[449]?>: <abbr title="<?php echo $text[425] ?>"><?php echo $text[424]?></abbr>,&nbsp;<abbr title="<?php echo $text[433] ?>"><?php echo $text[442]?></abbr></td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right">
            ...
            <td><?php echo $text[449]?>: <abbr title="<?php echo $text[427] ?>"><?php echo $text[426]?></abbr></td>
          </tr><?php
}?>
          <tr>
