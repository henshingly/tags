    ...
    for ($y1 = 1; $y1 < $anzst+1; $y1++) {
      ...
      for($i1 = 0; $i1 < $anzsp; $i1++) {
        if (($teama[$y1-1][$i1] > 0) && ($teamb[$y1-1][$i1] > 0)) {
          ...
          // Abfrage Grï¿½ne-Tisch-Entscheidung-Anfang
          ...
          if ($heimtore!='_' &&  $gasttore!='_') {
            ...
            // Hï¿½chster-Sieg checken-Ende

            // Hï¿½chster-Auswï¿½rtssieg checken-Anfang
            ...
            // Hï¿½chster-Auswï¿½rtssieg checken-Ende
