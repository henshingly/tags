...
while (list ($key, $val) = each ($datsort)) {
  ...
  <tr><?php
    ...
    <td width="2">&nbsp;</td>
    <td align="right"><?php=applyFactor($goala[$st-1][$i],$goalfaktor); ?></td>
    <td align="center" width="8">:</td>
    <td align="left"><?php=applyFactor($goalb[$st-1][$i],$goalfaktor); ?></td><?php
    if($spez==1) {?>
    <td width="2">&nbsp;</td>
    ...
    if ($msieg[$st-1][$i]==3){ ?>
    <td width="2">/</td>
    <td align="right"><?php=applyFactor($goalb[$st-1][$i],$goalfaktor); ?></td>
    <td align="center" width="8">:</td>
    <td align="left"><?php=applyFactor($goala[$st-1][$i],$goalfaktor); ?></td><?php
    }?>
    <td width="2">&nbsp;</td>
    <td class="nobr" align="left"><?php
