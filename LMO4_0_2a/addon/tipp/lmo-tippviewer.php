...
/** Liga Manager Online 4
  ...
  *
  * $Id: lmo-tippviewer.php 419 2007-04-08 18:32:36Z lmo-plastic $
  */
...
<table class="lmoMiddle" cellspacing="0" cellpadding="0" border="0">
  ...
  for($i=0;$i<$anzspiele;$i++){
    ...
    if ($i == 0 || $liga[$i] != $liga[$i-1] || $spieltag[$i] != $spieltag[$i-1]) {
      ...
      if($tipp_tippmodus==1){ 
        if($tipp_showdurchschntipp==1){ ?>
          <th class="nobr" colspan="2"><?php="Ø-".$text['tipp'][30]; /* DurchschnittsTipp */?><br><?php
          if ($goalfaktor[$i]!=1) {
    ...
    if ($tipp_tippmodus == 1) {
      ...
      if($btip==true){?>
        ...
        if($tipp_pfeiltipp==1){ ?>
          ...
          <td class="nobr"><?php echo $tippb[$i]; ?></td><?php 
        if($tipp_pfeiltipp==1){ ?>
          <td class="nobr">&nbsp;</td><?php 
        }
      }
    ...
    if ($tipp_jokertipp == 1) {
      if ($tipp_jokertippaktiv[$i] > 0 && $tipp_jokertippaktiv[$i] < time()) {
        $btip = false;
          ...
          <td class="lmoBackMarkierung" align="right"><?php=applyFactor($goala[$i],$goalfaktor[$i]); ?></td>
          <td class="lmoBackMarkierung">:</td>
          <td class="lmoBackMarkierung" align="left"><?php=applyFactor($goalb[$i],$goalfaktor[$i]); ?></td>
          <td class="lmoBackMarkierung"></td>
    ...
    if ($punktespiel == -1) {
      ...
      if ($tipp_tippmodus == 1) {
        ...
        <tr>
          <td colspan="<?php echo $breite; ?>" align="right"><?php 
  if($savebutton==1){ ?>
