...
/** Liga Manager Online 4
  ...
  *
  * $Id: lmo-tippeditliga.php 419 2007-04-08 18:32:36Z lmo-plastic $
  */
  ?>
<tr><?php
...
if ($tipp_jokertipp==1){ ?>
  ...
  <td class="lmoBackMarkierung" align="right"><?php=applyFactor($goala[$st-1][$i],$goalfaktor); ?></td>
  <td class="lmoBackMarkierung" align="center">:</td>
  <td class="lmoBackMarkierung" align="left"><?php=applyFactor($goalb[$st-1][$i],$goalfaktor); ?></td><?php 
if($spez==1){ ?>
