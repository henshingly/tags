...
/** Liga Manager Online 4
  ...
  *
  * $Id: lmo-tippeditko.php 419 2007-04-08 18:32:36Z lmo-plastic $
  */
...
/**ERGEBNISMODUS*/
  if($tipp_tippmodus==1){
    ...
    <td align="left"><?php echo $goaltippb[$i][$n]; ?></td><?php 
      if($tipp_pfeiltipp==1){ ?>
    <td>&nbsp;</td><?php 
      }
    }
...
/**BEIDE*/
  if ($tipp_jokertipp==1){ ?>
    <td align="center"><input type="radio" name="xjokerspiel" value="<?php=($i+1).($n+1); ?>" <?php if($jksp==($i+1).($n+1)){echo " checked";} if($btip[$i][$n]==false){echo " disabled";}elseif($tipp_jokertippaktiv==false){echo " disabled";} ?>></td><?php 
  }?>                                                                                                                   
