    ...
    <td align="center">
      <form name="lmotippedit" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <table class="lmoInner" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><?php=" ".$text['tipp'][140]; ?> &nbsp;</td>
          ...
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><?php=" ".$text['tipp'][139]; ?> &nbsp;</td>
          ...
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><?php=" ".$text['tipp'][139]." ".$text['tipp'][19]; ?> &nbsp;</td>
