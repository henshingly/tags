    ...
    $ende1=$ende;
          ...
          <tr>
            ...
            <td align="left">
              ...
              <input class="lmo-formular-input" type="text" name="tage" size="2" maxlength="2" value="<?php echo $tage; ?>" onFocus="emailart[2].checked=true;changetextarea(1);"><?php=" ".$text['tipp'][171];?>
            </td>
          </tr>          
          <tr>
            <th colspan="4">&nbsp;</th>
