...
<table class="lmoInner" cellspacing="0" cellpadding="0" border="0">
  ...
  <tr>
    ...
    if($tipp_realname!=0){ ?>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><?php=" ".$text['tipp'][14]; ?> &nbsp;</td>
            <td class="nobr" align="left"><input class="lmo-formular-input" type="text" name="xtippervorname" size="25" maxlength="32" value="<?php=substr($tipp_tipper_daten[3],0,strpos($tipp_tipper_daten[3]," ")); ?>"> &nbsp;</td>
          </tr>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><?php=" ".$text['tipp'][15]; ?> &nbsp;</td>
            <td class="nobr" align="left"><input class="lmo-formular-input" type="text" name="xtippernachname" size="25" maxlength="32" value="<?php=substr($tipp_tipper_daten[3],strpos($tipp_tipper_daten[3]," ")+1); ?>"> &nbsp;</td>
          </tr>
<?php  }
    if($tipp_adresse==1){ ?>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><?php=" ".$text['tipp'][126]; ?> &nbsp;</td>
          ...
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><?php=" ".$text['tipp'][127]; ?> &nbsp;</td>
          ...
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><?php=" ".$text['tipp'][128]; ?> &nbsp;</td>
...
<?php  } ?>
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><?php=" ".$text['tipp'][16]; ?> &nbsp;</td>
    ...
    if ($tipp_freischaltcode==1) {?>
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right"><acronym title="<?php echo $text['tipp'][300]?>"><?php=" ".$text['tipp'][16]." ".$text['tipp'][19]; ?></acronym></td>
