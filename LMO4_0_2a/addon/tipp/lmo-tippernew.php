...
if($newpage!=1){ ?>
  <tr>
    <td colspan="3" align="center">
      <form name="lmotippedit" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <input type="hidden" name="newpage" value="<?php=(1); ?>">
        <table class="lmoInner" cellspacing="0" cellpadding="0" border="0">
          <caption><?php echo $text['tipp'][13]; ?></caption>
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right"><?php=" ".$text['tipp'][23]; ?></td>
  ...
  if($tipp_realname!=0){ ?>
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right"><?php=" ".$text['tipp'][14]; ?></td>
          ...
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right"><?php=" ".$text['tipp'][15]; ?></td>
  ...
  if($tipp_adresse==1){ ?>
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right"><?php=" ".$text['tipp'][126]; ?></td>
  ...
  if ($tipp_freischaltcode==1) {?>
          ...
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right"><?php=" ".$text[308]; ?></td>
          ...
          <tr>
            <td width="20">&nbsp;</td>
            <td align="right"><?php=" ".$text[308]." ".$text['tipp'][19]; ?></td>
