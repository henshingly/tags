...
/** Liga Manager Online 4
  ...
  *
  * $Id: lmo-statadmin.php 352 2005-10-09 09:29:31Z jokerlmo $
  */
		...
		<td>
			<table class="lmoInner">
					...
					<td class="nobr" align="left">
						<form action="<?php= $_SERVER['PHP_SELF']?>" method="post">
							<acronym title="<?php echo $text['spieler'][10]?>"><select name="wert" size="1"><?php
								for ($x=0;$x<$zeile;$x++) {?>
								<option value="<?php echo $x?>"><?php=htmlentities(stripslashes($data[$x][0]),ENT_COMPAT);?></option><?php
								}?>
              ...
              <input type="hidden" name="st" value="<?php echo $st; ?>">
				...
				<tr>
					<td class="nobr" align="right">
						<form action="<?php= $_SERVER['PHP_SELF']?>" method="post" name="spalten">
              ...
              <input type="hidden" name="st" value="<?php echo $st; ?>">
					...
					<td class="nobr" align="left" valign="top">
						<form action="<?php= $_SERVER['PHP_SELF']?>" method="post" name="spieler">
							<acronym title="<?php echo $text['spieler'][8]?>"><select name="wert" size="1"><?php
								for ($x=0;$x<$spaltenzahl;$x++) {?>
								<option value="<?php echo $x?>"<?php if ($x==0){?> disabled<?php}if ($x==1){?> selected<?php}?>><?php=htmlentities(stripslashes($spalten[$x]),ENT_COMPAT);?></option><?php
								}?>
							</select></acronym>&nbsp;<input class="lmo-formular-button" type="submit" value=" &minus; ">
	  ...
	  <td>
        ...
        <table id="stats" class="lmoInner" >
                ...
                $stat_sort=$_SERVER['PHP_SELF']."?action=admin&amp;todo=statistik&amp;sort=".$i."&amp;file=".$file."&amp;direction=";?>
                  ...
                  <input type="text" name="spalten<?php echo $i?>" onChange="mark(this)" value="<?php echo $spalten[$i]?>" size="<?php=strlen($spalten[$i]);?>">
              ...
              <tr><?php
                for ($i=0;$i<$spaltenzahl;$i++) {?>
                  ...
                  if ($formel[$i]){?>
                    <input type="text" onClick="sel('formel_str<?php echo $i?>')" onChange="mark(this)" name="formel_str<?php echo $i?>" value="<?php echo $formel_str[$i]?>" size="<?php=strlen($formel_str[$i]);?>"><?php
                  } elseif ($i==0) {
            ...
            if (isset($formel[$j2]) && $formel[$j2]==1){?>
                ...
                <input type="text" name="data<?php echo $j1."|".$j2?>" value="<?php echo $data[$j1][$j2]?>" size="<?php=strlen($data[$j1][$j2]);?>" disabled>
              </td><?php
            }elseif (is_numeric($data[$j1][$j2])){?>
							<td align="right">
                <input type="text" name="data<?php echo $j1."|".$j2?>" value="<?php= $data[$j1][$j2]?>" size="<?php=strlen($data[$j1][$j2]);?>">
              </td>
              <td align="left">
        ...
        <input type="hidden" name="st" value="<?php echo $st; ?>">
            ...
            <th colspan="2"><?php echo $text['spieler'][45]?></th>
					...
					<tr>
						...
						<td align="right">
							<input type="text" name="anzeige_pro_seite"value="<?php= $spieler_anzeige_pro_seite?>" size="<?php=strlen($spieler_anzeige_pro_seite);?>">
						</td>
            <td align="left">
          ...
          <tr>
						...
						<td colspan="2" align="left"><input type="text" name="ligalink" onChange="mark(this)" value="<?php= $spieler_ligalink?>" size="<?php=strlen($spieler_ligalink);?>"></td>
					</tr>
					<tr>
