...
if($newpage!=1){ ?>
  ...
  if($tipp_tipperimteam>=0){ ?>
          ...
          <tr>
            <td align="left" class="lmoFooter" colspan="3"><a href="<?php echo $_SERVER['PHP_SELF']."?action=tipp"; ?>" title="<?php echo $text['tipp'][110]; ?>">ï¿½ <?php echo $text['tipp'][110]; ?></a></td>
          </tr>
        </table>
      </form>
    </td>
  ...
  <tr>
    <td align="center">
      <table width="100%" class="lmoInner" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
          <td class="lmoFooter" align="right"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=tipp&amp;todo=logout&amp;">ï¿½ <?php echo $text['tipp'][21]; ?></a></td>
        </tr>
      </table>
    </td>
  </tr><?php
