    ...
    for ($y1 = 1; $y1 < $anzst+1; $y1++) {
      ...
      for($i1 = 0; $i1 < $anzsp; $i1++) {
        if (($teama[$y1-1][$i1] > 0) && ($teamb[$y1-1][$i1] > 0)) {
          ...
          // Abfrage Gr�ne-Tisch-Entscheidung-Anfang
          ...
          if ($heimtore!='_' &&  $gasttore!='_') {
            ...
            // H�chster-Sieg checken-Ende

            // H�chster-Ausw�rtssieg checken-Anfang
            ...
            // H�chster-Ausw�rtssieg checken-Ende
